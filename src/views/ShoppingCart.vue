<template>
    <section class="wow animate__fadeIn bg-light-gray padding-25px-tb page-title-small" style="visibility: visible; animation-name: fadeIn;">
        <div class="container">
                                ...
                                <tbody>
                                    <tr> 
                                        <td class="product-remove">
                                            <a href="#" class="btn-default text-large">×</a>
                                        </td>
                                        <td class="product-thumbnail"><a href="single-product.html"><img class="cart-product-image" src="https://via.placeholder.com/600x765" alt="" data-no-retina=""></a></td>
                                    ...
                                    <td data-title="Shipping">
                                        <ul class="float-lg-start float-end text-start line-height-36px">
                                            <li class="d-flex align-items-center md-margin-15px-bottom">
                                                <input id="free_shipping" type="radio" name="shipping-option" class="d-block w-auto margin-10px-right mb-0">
...
.cart-products .product-name .variation .variation-Size{ margin-right: .25em; display: inline-block; list-style: none outside; font-weight: normal;}
